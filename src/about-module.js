export function handleAboutClick(wrapper){
    ...
    aboutPara.textContent = `"  You know its been a long time since I thought about coming up with a restaurant page of my own.
    Have you ever thought about making one? What type of theme are you going to use? What type of color palette. I was 
